                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            if (num1.text.trim().isEmpty ||
                              ...
                              setState(() {
                                sum.text = (int.parse(num1.text) +
                                        int.parse(num2.text))
                                    .toString();
                                sub.text = (int.parse(num1.text) -
                                        int.parse(num2.text))
                                    .toString();
                                mul.text = (int.parse(num1.text) *
                                        int.parse(num2.text))
                                    .toString();
                                div.text = (int.parse(num1.text) /
                                        int.parse(num2.text))
                                    .toString();
                              });
                            }
